...
<html>
    ...
    <body>
        <?php echo Functions::formTitle("", "Surgical Evaluation", $extremity) ?><br>
        &nbsp;
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                foreach ($surgicalValues['Q22'] as $opt) {
                                    echo "<td>";
                                    echo "<input type = 'checkbox' name = 'Q22[]'  value = '" . $opt['val'] . "' " . (in_array($opt['val'], explode("|", $surgical->getAnswer("Q22"))) ? "checked='checked'" : "") . $func->disableElement($mode) . "/>" . $opt['name'];

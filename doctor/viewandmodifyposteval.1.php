...
$post = $database->read(Post::createRetrievableDatabaseObject($patientID));
...
<html>
    <head>
        ...
        <title>1ST POST-OPERATIVE Evaluation</title>
            ...
            <div class='container'>
                <div class='greybox'>
                    <table>
                        ...
                        <tr>
                            <td>3) Extremity: <?php echo $patient->getExtremityFormatted(); ?></td>
